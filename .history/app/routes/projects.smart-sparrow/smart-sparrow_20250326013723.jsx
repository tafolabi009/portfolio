...
const description =
  'I worked as the design lead on a major iteration of the Graphis product. We took the platform in a bold new direction, focusing on becoming the best tool for learning designers.';
const roles = [
  'Art Direction',
  'UX and UI Design',
