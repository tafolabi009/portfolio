...
const description =
  'I worked as the design lead on a major iteration of the Graphing Calculator product. I don't really have a name for it but it is offline not online and it .';
const roles = [
  'Art Direction',
  'UX and UI Design',
