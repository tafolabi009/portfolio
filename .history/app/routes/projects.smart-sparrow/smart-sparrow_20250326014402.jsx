...
const description =
  "I worked as the design lead on a major iteration of the Graphing Calculator product. I don't really have a name for it but it is offline not online and it is fater.";
const roles = [
      ...
      <ProjectContainer>
        ...
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
              Most graphing calculators were online and didn&apos;t work well offline. I wanted to create a graphing calculator that worked offline and was faster than the current ones.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
              ...
              <ProjectSectionText>
                I created the design myself and developed it alone. I wanted to create a design system that was easy to use and understand.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
        <ProjectSection>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
              ...
              <ProjectSectionText>
                A design system is useless if no one knows how to use it.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionText>
                The project was a success and the graphing calculator is now being used in schools across the country.  The calculator is faster than the previous ones and works offline.  The design system is easy to use and understand.
          </ProjectSectionContent>
        </ProjectSection>
      </ProjectContainer>
      <Footer />
