...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      ...
      <Link href="https://www.qwilr.com">Qwilr</Link>. My projects include ML models, software, and icon illustration. Being comfortable with code allows me to rapidly
