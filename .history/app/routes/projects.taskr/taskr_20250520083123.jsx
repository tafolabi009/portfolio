...
import imageTaskrLightLightLarge from '~/assets/Taskr.png';
import imageSprLessonBuilderLightPlaceholder from '~/assets/spr-lesson-builder-light-placeholder.jpg';
import imageTaskrLightLight from '~/assets/spr-lesson-builder-light.jpg';
        ...
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectImage
              ...
              srcSet={
                isDark
                  ? `${imageTaskrDark} 1280w, ${imageTaskrDark} 2560w`
                  : `${imageTaskrLight} 1280w, ${imageTaskrLightLarge} 2560w`
              }
              width={1280}
              height={800}
              placeholder={
